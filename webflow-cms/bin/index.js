...
},{"whatwg-fetch":24}],12:[function(require,module,exports){
...
},{"call-bind/callBound":2,"get-intrinsic":7,"object-inspect":12}],19:[function(require,module,exports){
"use strict";
...
},{"./ResponseWrapper":19,"./WebflowError":21,"./utils":23,"isomorphic-fetch":11,"qs":14}],21:[function(require,module,exports){
"use strict";
...
},{"es6-error":4}],22:[function(require,module,exports){
"use strict";

module.exports = require("./Webflow")["default"];
module.exports.WebflowError = require("./WebflowError")["default"];
},{"./Webflow":20,"./WebflowError":21}],23:[function(require,module,exports){
"use strict";
...
var _webflowApi = _interopRequireDefault(require("webflow-api"));
...
var WebflowCMS = /*#__PURE__*/function () {
  function WebflowCMS(token) {
    _classCallCheck(this, WebflowCMS);

    this.webflow = new _webflowApi["default"]({
      token: token
    });
    this.token = token;
  }
  ...
  _createClass(WebflowCMS, [{
    key: "getSites",
    value: function () {
      var _getSites = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.webflow.info();

              case 2:
                return _context.abrupt("return", _context.sent.sites);
    ...
    key: "getCollections",
    value: function () {
      var _getCollections = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(siteId) {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return this.webflow.collections({
                  siteId: siteId
                });
    ...
    value: function () {
      var _getCollectionByName = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(collections, name) {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                return _context3.abrupt("return", collections.find(function (collection) {
      ...
      function getCollectionByName(_x2, _x3) {
        return _getCollectionByName.apply(this, arguments);
      }
    ...
    key: "getItems",
    value: function () {
      var _getItems = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(collection) {
    ...
    key: "getItemsByName",
    value: function () {
      var _getItemsByName = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(collection, name) {
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                return _context5.abrupt("return", _context5.sent.items.find(function (item) {
      ...
      function getItemsByName(_x5, _x6) {
        return _getItemsByName.apply(this, arguments);
      }
    ...
    key: "updateItem",
    value: function () {
      var _updateItem = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(itemId, collectionId, data) {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 3;
                return this.webflow.updateItem({
                  itemId: itemId,
                  collectionId: collectionId,
                  fields: data
                }, {
      ...
      function updateItem(_x7, _x8, _x9) {
    ...
    key: "createItem",
    value: function () {
      var _createItem = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(collectionId, data) {
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.next = 2;
                return this.webflow.createItem({
                  collectionId: collectionId,
                  fields: data
                }, {
                  live: true
